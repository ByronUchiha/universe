...
echo "$($PSQL "SELECT DISTINCT(name) FROM games AS g INNER JOIN teams ON teams.team_id IN (g.winner_id, g.opponent_id) WHERE g.year=2014 AND g.round='Eighth-Final'")"
